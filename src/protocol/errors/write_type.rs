...
pub enum WriteType {
    ...
    /// La escritura fue de tipo batch (logged). Esto signifca que el log del batch fue escrito correctamente, caso contrario, se debería haber enviado el tipo [BATCH_LOG](crate::protocol::errors::write_type::WriteType::BatchLog).
    Batch,

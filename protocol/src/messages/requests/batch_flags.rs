...
///
/// ```rust
/// # use protocol::messages::requests::batch_flags::BatchFlag;
...
pub enum BatchFlag {
    ...
    /// Esto tiene un significado similar al de las [Query Flags](crate::messages::requests::query_flags::QueryFlag::Values).

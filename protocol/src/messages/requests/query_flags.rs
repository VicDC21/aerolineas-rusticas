...
/// ```rust
/// # use protocol::messages::requests::query_flags::QueryFlag;
/// # use protocol::traits::Maskable;
...
pub enum QueryFlag {
    ...
    /// El resultado de la _response_ tendrá activada la flag [NO_METADATA](crate::messages::responses::result::rows_flags::RowsFlag::NoMetadata).
    SkipMetadata,
    ...
    /// Usa consistencia del tipo [SERIAL](crate::notations::consistency::Consistency::Serial) o [LOCAL_SERIAL](crate::notations::consistency::Consistency::LocalSerial).
    WithSerialConsistency,

    /// Indica que el _query_ trae un _timestamp_ en microsegundos.
    WithDefaultTimestamp,

    /// _(Sólo tiene sentido si [VALUES](crate::messages::requests::query_flags::QueryFlag::Values) está seteado)_.

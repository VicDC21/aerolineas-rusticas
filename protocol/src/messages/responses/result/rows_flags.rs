...
/// Las flags a ser incluidas en el mensaje de una _response_ RESULT de tipo [ROWS](crate::messages::responses::result_kinds::ResultKind::Rows).
/// ```rust
/// # use protocol::messages::responses::result::rows_flags::RowsFlag;

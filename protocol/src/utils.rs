...
/// 2 bytes ([Short](crate::aliases::types::Short)), seguido del contenido mismo del
/// [String], en donde cada _byte_ representa un carácter UTF-8.
///
/// ```rust
/// # use protocol::utils::encode_string_to_bytes;
...
///
/// Más específicamente, el protocolo pide que primero vaya un entero de
/// 4 bytes ([Int](crate::aliases::types::Int)), seguido del contenido mismo del
/// [String], en donde cada _byte_ representa un carácter UTF-8.
///
/// ```rust
/// # use protocol::utils::encode_long_string_to_bytes;
...
///
/// ```rust
/// # use protocol::utils::encode_ipaddr_to_bytes;
...
///
/// Comienza con un [Int](crate::aliases::types::Int), indicando la cantidades de pares
...
/// # use std::net::{IpAddr, Ipv4Addr, Ipv6Addr};
/// # use protocol::aliases::types::Short;
/// # use protocol::utils::encode_reasonmap_to_bytes;
...
///
/// Dicha cantidad es expresada con un [Int](crate::aliases::types::Int), y luego le sigue
/// el contenido de [Byte]s tal cual.
///
/// ```rust
/// # use protocol::utils::encode_bytes_collection_to_bytes;
...
///
/// ```rust
/// # use protocol::utils::encode_iter_to_bytes;
...
///
/// ```rust
/// # use protocol::utils::parse_bytes_to_string;
...
///
/// ```rust
/// # use protocol::utils::parse_bytes_to_long_string;
/// # use protocol::aliases::results::Result;
/// let string = "World!".to_string();
///
/// let mut i_1: usize = 0;
...
/// Esta es la operación recíproca a [encodearlo](crate::utils::encode_ipaddr_to_bytes),
...
///
/// Esta es la operación recíproca a [encodearlo](crate::utils::encode_reasonmap_to_bytes),
/// y requiere de tanto el _slice_ de _bytes_ como el índice desde donde comenzar a parsear el mismo.
///
/// ```rust
/// # use std::net::{IpAddr, Ipv4Addr, Ipv6Addr};
/// # use protocol::utils::parse_bytes_to_reasonmap;
/// # use protocol::aliases::results::Result;
/// let bytes = vec![
